...
async function sendNotification(
  ...
  const embed = {
    ...
    fields: [
      ...
      { name: 'Frustration', value: answers.frustration || '_(none)_', inline: true },
      { name: 'Confidence', value: answers.confidence || '_(none)_', inline: true },
      { name: 'Question', value: truncate(answers.question || '', 200), inline: false },
    ],
