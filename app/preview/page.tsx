        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg px-4 py-3 flex items-center justify-between">
          <div>
            ...
            <span className="text-slate-400 text-sm ml-2">
              ...
              {landingSubTab === 'invite' && 'Bypasses window — pay in full or split in 2 ($600 × 2). The /join?plan=three link swaps the split to 3× $333.'}
            </span>
          </div>
          <a
            href={src}
    ...
    <div className="space-y-8">
        ...
        <div className="bg-slate-950 p-6">
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { label: 'Invite Page — 2-pay default (bypasses window)', href: '/join' },
              { label: 'Invite Page — 3-pay link (split in 3)', href: '/join?plan=three' },
      ...
      <div className="border border-slate-700 rounded-lg overflow-hidden">
        ...
        <div className="bg-slate-950 p-6 space-y-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-4">
            <h4 className="text-white font-semibold text-sm mb-2">Installment — $600 × 2 (/join default)</h4>
            <p className="text-slate-400 text-sm">The default split button on /join. Stripe Checkout → subscription mode → $600 now → webhook sets cancel_at from total_payments (~50 days) → $600 at day 30 → auto-cancels before a 3rd charge.</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-4">
            <h4 className="text-white font-semibold text-sm mb-2">Installment — $333 × 3 (/join?plan=three)</h4>
            <p className="text-slate-400 text-sm">The separate 3-pay link (/join?plan=three) and the /invite/pay links. Subscription mode → $333/mo → webhook sets cancel_at from total_payments (~80 days) → auto-cancels after the 3rd charge. Same $999 total, no upcharge.</p>
          </div>
        </div>
      </div>
