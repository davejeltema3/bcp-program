...
export default function CheckoutPage() {
  ...
  const features = [
    ...
    'Weekly live group session (Wednesdays 2 PM EST)',
    'Full BCP resource library',
    'Direct access to Dave in Discord',
    'Founders role + locked-in rate',
  ];
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg overflow-hidden shadow-xl">
          ...
          {/* Price */}
          <div className="p-6 md:p-8 border-b border-slate-800 text-center">
            <div className="text-4xl font-bold text-white mb-1">$999</div>
            <div className="text-slate-400 text-sm">One-time payment for 3 months</div>
            <div className="text-slate-500 text-xs mt-1">No auto-renewal. No hidden fees.</div>
          </div>

          {/* Checkout or Waitlist */}
